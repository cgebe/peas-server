...
/**
 * HTTP request parsing as defined by RFC 2612:
 */
public class HttpRequestParser {
    ...
    private void setRequestLine(String requestLine) throws HttpFormatException {
        ...
        if (requestLine == null || requestLine.length() == 0 || requestLineParts.length < 2) {
            throw new HttpFormatException("Invalid Request-Line: " + requestLine);
        }
        _requestLine = requestLine;
        _requestMethod = requestLineParts[0];
        _requestPath = requestLineParts[1];
        _requestVersion = requestLineParts[2];
    }
